...
namespace ProyectoCayoAhoraSiQSi.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            var sistemaCftContext = _context.Nota.Include(n => n.Asignatura).Include(n => n.Estudiante);
        ...
        public async Task<IActionResult> Create([Bind("Id,Calificacion,Ponderacion,FechaRegistro,AsignaturaId,EstudianteId")] Nota nota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Calificacion,Ponderacion,FechaRegistro,AsignaturaId,EstudianteId")] Nota nota)
        {
            if (id != nota.Id)
            {
                return NotFound();
